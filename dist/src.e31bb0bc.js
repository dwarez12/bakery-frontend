...
class UserAPI {
  ...
  async addFavCake(cakeId) {
    // validate
    if (!cakeId) return; // fetch the json data

    const response = await fetch("".concat(_App.default.apiBase, "/user/addFavCake"), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
        "Content-Type": 'application/json'
    ...
    if (!response.ok) {
      ...
      throw new Error('Problem adding cake to cart');
    } // convert response payload into json - store as data
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../UserAPI":"UserAPI.js"}],"views/pages/bakers.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"Bakers\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>Bakers</h1>\n        <p>Page content ...</p>\n        \n      </div>      \n    "]);
...
var _default = new BakersView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"CakeAPI.js":[function(require,module,exports) {
"use strict";
...
class CakeAPI {
  async newCake(formData) {
    // send fetch request
    const response = await fetch("".concat(_App.default.apiBase, "/cakes"), {
      method: 'POST',
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      },
...
var _default = new CakeAPI();

exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/cakes.js":[function(require,module,exports) {
"use strict";
...
var _CakeAPI = _interopRequireDefault(require("../../CakeAPI"));
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"Cakes\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        \n      <div class=\"cakes-grid\">\n      ", "\n      </div>\n      \n      </div>      \n    "]);
...
class CakesView {
  ...
  async getCake() {
    try {
      this.Cake = await _CakeAPI.default.getCake();
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.Cake == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.Cake.map(cake => (0, _litHtml.html)(_templateObject4(), cake._id, cake.cakeName, cake.description, cake.price, JSON.stringify(cake.user), _App.default.apiBase, cake.image, cake.cakeSize))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new CakesView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../CakeAPI":"CakeAPI.js"}],"views/pages/newCake.js":[function(require,module,exports) {
"use strict";
...
class newCakeView {
  ...
  newCakeSubmitHandler(e) {
    ...
    try {
      _CakeAPI.default.newCake(formData);

      _Toast.default.show('Cake added!');
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.newCakeSubmitHandler, _Auth.default.currentUser._id);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new newCakeView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../CakeAPI":"CakeAPI.js","../../Toast":"Toast.js"}],"views/pages/cart.js":[function(require,module,exports) {
"use strict";
...
class Cart {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.getFavCake == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3()));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new Cart();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js","../../CakeAPI":"CakeAPI.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _bakers = _interopRequireDefault(require("./views/pages/bakers"));

var _cakes = _interopRequireDefault(require("./views/pages/cakes"));

var _newCake = _interopRequireDefault(require("./views/pages/newCake"));
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/bakers":"views/pages/bakers.js","./views/pages/cakes":"views/pages/cakes.js","./views/pages/newCake":"views/pages/newCake.js","./views/pages/cart":"views/pages/cart.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
function _templateObject3() {
  const data = _taggedTemplateLiteral(["\n        <a href=\"/newCake\" @click=\"", "\">Add Cake</a> \n        "]);
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","./../Router":"Router.js","./../Auth":"Auth.js","./../App":"App.js"}],"components/va-app-cake.js":[function(require,module,exports) {
"use strict";
...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["\n    <style>\n      .author {\n        font-size: 0.9em;\n        font-style: italic;\n        opacity: 0.8;\n      }\n    </style>\n\n    <sl-card>\n      <img slot=\"image\" src=\"", "\" />\n      <h2>", "</h2>\n      <h3>$", "</h3>\n      <p class=\"author\"> By ", " ", "</p>\n      <sl-button @click=", ">More Info</sl-button>\n      <sl-icon-button name=\"basket2\" label=\"Add to Cart\" @click=", "></sl-icon>\n\n    </sl-card>\n    "]);
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n          <style>\n                .wrap {\n                  display: flex;\n                }\n                .image {\n                  width: 50%;\n                }\n                .image img {\n                  width: 100%;\n                }\n                .content {\n                  padding-left: 1em;\n                }\n                .gender span,\n                \n           </style>\n            <div class=\"wrap\">\n              <div class=\"image\">\n                <img src=\"", "\" alt=\"", "\" />\n              </div>\n              <div class=\"content\">\n                <h1>", "</h1>\n                <p class=\"price\">$", "</p>\n                <p class=\"gender\">Description : <span>", "</span></p>\n                <p class=\"length\">Cake Size: <span>", "</span></p>\n\n                <sl-button @click=", ">\n                  <sl-icon slot=\"prefix\" name=\"basket2\"></sl-icon>\n                  Add to Cart\n                </sl-button>\n              </div>\n            </div>\n    "]);
...
customElements.define('va-app-cake', class Cake extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  moreInfoHandler() {
    ...
    const dialogContent = (0, _litElement.html)(_templateObject(), this.image, this.name, this.cakeName, this.price, this.description, this.cakeSize, this.addFavCake.bind(this));
  ...
  async addFavCake() {
    try {
      _UserAPI.default.addFavCake(this.id);

      _Toast.default.show('Cake added cart');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  }
  ...
  render() {
    return (0, _litElement.html)(_templateObject2(), this.image, this.cakeName, this.price, this.user.firstName, this.user.lastName, this.moreInfoHandler.bind(this), this.addFavCake.bind(this));
  }
...
require("./components/va-app-cake");
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-app-cake":"components/va-app-cake.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
